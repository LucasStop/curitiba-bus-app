...
-- Rodada 2: AA001 andou, BB002 sumiu do feed.
select is(
  public.ingest_bus_positions(
    '[{"prefix":"AA001","line_code":"203","lat":-25.41,"lon":-49.31,"refreshed_at":"2026-09-25T20:02:00Z","status":"late","route_state":"on_route","urbs_direction":"IDA","accessible":true}]'::jsonb,
...
select is_empty(
  ...
  'onibus que saiu do feed e apagado'
);
